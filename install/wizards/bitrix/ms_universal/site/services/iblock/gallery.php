...
$iblockCode = "gallery_".WIZARD_SITE_ID; 
$iblockType = "gallery"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/gallery/index.php", array("GALLERY_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/about/index.php", array("GALLERY_IBLOCK_ID" => $iblockID));
