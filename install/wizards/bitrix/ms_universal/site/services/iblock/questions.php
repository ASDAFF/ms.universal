...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/questions.xml"; 
$iblockCode = "questions_".WIZARD_SITE_ID; 
$iblockType = "questions"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/questions/index.php", array("QUESTIONS_IBLOCK_ID" => $iblockID));
?>
