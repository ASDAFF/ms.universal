...
<ul class="grid">
		...
		<li id="<?=$this->GetEditAreaId($arElement['ID']);?>">
					...
					<?if(is_array($arElement["PREVIEW_PICTURE"])):?>
						<a class="img" href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img src="<?=$arElement["PREVIEW_PICTURE"]["SRC"]?>" width="<?=$arElement["PREVIEW_PICTURE"]["WIDTH"]?>" height="<?=$arElement["PREVIEW_PICTURE"]["HEIGHT"]?>" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" /><span></span></a>
					<?elseif(is_array($arElement["DETAIL_PICTURE"])):?>
						<a class="img" href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img src="<?=$arElement["DETAIL_PICTURE"]["SRC"]?>" width="<?=$arElement["DETAIL_PICTURE"]["WIDTH"]?>" height="<?=$arElement["DETAIL_PICTURE"]["HEIGHT"]?>" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" /><span></span></a>
					<?endif?>
